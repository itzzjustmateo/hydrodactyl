        ...
        <div className='space-y-6 mt-4'>
                ...
                <div className='flex items-center justify-between mb-6'>
                    <div className='flex items-center gap-3'>
                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center transition-colors ${editing ? 'bg-brand/20' : 'bg-mocha-400'}`}>
                            <HugeiconsIcon icon={Link02Icon} className={`w-5 h-5 ${editing ? 'text-brand' : 'text-cream-400'}`} />
                        </div>
                        <div>
            ...
            >
                <div className='flex items-center justify-between mb-6'>
                    <div className='flex items-center gap-3'>
                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center transition-colors ${editing ? 'bg-brand/20' : 'bg-mocha-400'}`}>
                            <HugeiconsIcon icon={ServerStack02Icon} className={`w-5 h-5 ${editing ? 'text-brand' : 'text-cream-400'}`} />
                        </div>
                        <div>
                            <div className='flex items-center gap-2'>
